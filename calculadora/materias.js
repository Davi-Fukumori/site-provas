...
//
// AC2 nunca é digitada: ela vem da nota de Simulados (AC2) da área da matéria
// (Exatas, Línguas, Humanas ou Biológicas) somada a um Bônus, sem passar de 10.
// O "Simulado" que vale 20% da fórmula é a média dos 4 Simulados (AC2) por área —
// funciona como uma 3ª nota contínua (C3), só que com esse nome.
// O Bônus é outra coisa: uma nota extra ÷ 10, uma nota única (não por área).
// Tanto os Simulados (AC2) quanto o Bônus são os mesmos para todas as matérias.
//
