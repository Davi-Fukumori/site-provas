...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var elNotaExtra = document.getElementById("nota-extra");
  ...
  function criarCartao(materia) {
    ...
    subtitulo.textContent = "Área nos Simulados (AC2): " + AREAS_LABEL[materia.area];
  ...
  // AC2 e o Simulado (geral) vêm dos campos de área/nota extra (compartilhados), não
  ...
  function recalcularTudo() {
    ...
    var bonus = numero(elNotaExtra) / 10;
  ...
  elNotaExtra.addEventListener("input", function () {
    recalcularTudo();
    agendarSalvar();
  });
